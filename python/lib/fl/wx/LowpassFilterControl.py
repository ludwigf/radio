...
#   ============================================================================
class LowpassFilterControl(wx.Panel):
#   ============================================================================

    #   ------------------------------------------------------------------------
    def __init__(self, parent, name, cutoff=1000, transit=100, handlers=[]):
    #   ------------------------------------------------------------------------
        super(LowpassFilterControl, self).__init__(parent, size=(200,200))
        self.name = name
    ...
    def xInitGui(self):
    #   ------------------------------------------------------------------------
        cutoffLabel = wx.StaticText(self, label="Cutoff High:", size=(80,20),
        ...
        transitLabel = wx.StaticText(self, label="Transit High:", size=(80,20),
            style=wx.ST_NO_AUTORESIZE)
